...
public class StandAloneExample {
	...
	public static void main(String[] args) {
		...
		// above relies on default placement rules. You can force placement as a
		// premodifier
		...
		// note that constituents (such as subject and object) are set with setXXX
		// methods
		...
		// realiser.setDebugMode(true); // uncomment this to print out debug info during
		// realisation
		...
		// below is clumsy as direct access to morphology isn't properly supported in
		// V4.2
